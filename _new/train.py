######## COMMAND LINE HELPER ########
# python train.py --data_dir imgfolder --gpu true --epochs 23 --arch alexnet --learning_rate 0.001 --checkpoint nnmodel.pt --hidden_units 2040
#
#
#
#
...
####################################################################
	...
	def load_model(arch='vgg19', num_labels=2, hidden_units=4096):
		# PRETRAINED MODEL #
		if arch=='vgg19':
